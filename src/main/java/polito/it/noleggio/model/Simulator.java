...
public class Simulator {
	...
	private int NC = 10; //numerber of cars
	private Duration T_IN = Duration.of(10, ChronoUnit.MINUTES); // intervalli tra i clienti
...
//SIMULAZIONE VERA E PROPRIA 
	public void run() {
		...
		//creo gli eventi
		this.queue.clear(); //pulisco la coda
		...
		while(!this.queue.isEmpty()) {
			//l'estrazione è in ordine (in questo caso di orario)
